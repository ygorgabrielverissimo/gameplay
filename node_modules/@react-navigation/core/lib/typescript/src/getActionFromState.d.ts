import type { NavigationState, PartialState, CommonActions } from '@react-navigation/routers';
import type { PathConfigMap, NavigatorScreenParams } from '@react-navigation/core/lib/typescript/src/types';
