import type { NavigationState, Router, DefaultRouterOptions, Route, ParamListBase } from '@react-navigation/routers/lib/typescript/src/types';
...
export default function StackRouter(options: StackRouterOptions): Router<StackNavigationState<Record<string, object | undefined>>, {
    ...
    payload: Readonly<{
        ...
        routes: (Readonly<{
            ...
            state?: Readonly<any> | import("@react-navigation/routers/lib/typescript/src/types").PartialState<Readonly<any>> | undefined;
        })[];
        type: string;
        stale: false;
    }> | import("@react-navigation/routers/lib/typescript/src/types").PartialState<Readonly<{
        key: string;
        index: number;
        routeNames: string[];
        history?: unknown[] | undefined;
